        ...
        <div className="partner-card-main">
          ...
          <div className="partner-actions">
            ...
            <Button
              variant="secondary"
              onClick={() =>
                track("partners_message_click", { partnerId: company._id })
              }
            >
              {t("partners_message")}
            </Button>
            <Button variant="ghost" onClick={() => handleViewDetails(match)}>
        ...
        {selectedMatch && (
          <div className="company-detail">
            <div className="muted small">
              {selectedMatch.company?.industry ||
                t("detail_industry_placeholder")}
            </div>
                ...
                <div className="analysis-row overall">
                  ...
                  <div className="analysis-meter" aria-hidden="true">
                    <span
                      ...
                      style={{ width: `${getAccuracyPercent(selectedMatch)}%` }}
                    />
                  </div>
                </div>
              )}
