...
const milestones = [
  {
    year: "2021",
    title: "Founded K-Statra",
    description:
      "Started with a mission to connect Korean suppliers with global enterprises.",
  },
  {
    year: "2022",
    title: "Global Matchmaking",
    description: "Launched AI partner search to handle 10K+ curated matches.",
  },
  {
    year: "2023",
    title: "Cross-border Payments",
    description: "Integrated XRP settlement rails and contract tracking.",
  },
];
...
const leadership = [
  {
    name: "Minseo Park",
    role: "CEO & Co-founder",
    bio: "Driving global expansion with 15+ years in B2B exports.",
  },
  {
    name: "David Kim",
    role: "Head of Partnerships",
    bio: "Leads partner operations across APAC, EMEA, and the US.",
  },
  {
    name: "Soojin Lee",
    role: "Product Lead",
    bio: "Builds AI-powered workflows for sourcing and payments.",
  },
];

const services = [
  {
    titleKey: "about_service_matchmaking_title",
    copyKey: "about_service_matchmaking_copy",
  },
  {
    titleKey: "about_service_intelligence_title",
    copyKey: "about_service_intelligence_copy",
  },
  {
    titleKey: "about_service_support_title",
    copyKey: "about_service_support_copy",
  },
];
