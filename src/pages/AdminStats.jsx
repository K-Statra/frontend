...
export default function AdminStats() {
  ...
  const statusData = stats?.byStatus
    ...
    : [];
  const currencyData = stats?.byCurrency
    ? Object.entries(stats.byCurrency).map(([name, value]) => ({ name, value }))
    : [];
      ...
      {stats && (
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <div className="row" style={{ gap: 16, flexWrap: "wrap" }}>
            <div
              className="card"
              style={{ padding: 16, flex: 1, minWidth: 200 }}
            >
          ...
          <div className="row" style={{ gap: 32, flexWrap: "wrap" }}>
            ...
            <div
              className="card"
              style={{ padding: 16, flex: "1 1 400px", height: 400 }}
            >
