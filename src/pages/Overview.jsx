...
const statSeed = [
  {
    id: "totalPartners",
    labelKey: "analytics_total_partners",
    value: "24",
    change: "+12%",
    icon: "👥",
    tone: "primary",
  ...
  {
    id: "activeDeals",
    labelKey: "analytics_active_deals",
    value: "12",
    change: "+8%",
    icon: "🎯",
    tone: "warning",
...
const activitiesSeed = [
  {
    id: 1,
    text: "New partnership established",
    detail: "EcoMobility Partners • 2 hours ago",
    status: "success",
  },
  {
    id: 2,
    text: "Contract renewal completed",
    detail: "BeautyTech Korea • 1 day ago",
    status: "neutral",
  },
  {
    id: 3,
    text: "Negotiation in progress",
    detail: "TechFlow Solutions • 2 days ago",
    status: "warning",
  },
];
