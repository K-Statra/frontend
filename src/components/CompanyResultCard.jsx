...
export default function CompanyResultCard({ company, onDetails }) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          >
            ...
            {/* AI Badge */}
            {(c.ai_reasoning ||
              (c.matchRecommendation &&
                !c.matchRecommendation.includes("No specific"))) && (
              <span
                style={{
                  display: "inline-flex",
                  alignItems: "center",
      ...
      >
        {c.profileText
          ? c.profileText.length > 200
            ? c.profileText.substring(0, 200) + "..."
            : c.profileText
          : t("detail_not_provided")}
      </p>
      ...
      {c.culturalTraits &&
        (c.culturalTraits.innovationScore || c.culturalTraits.speedScore) && (
          <div
            style={{
              marginTop: "0.75rem",
              padding: "0.75rem",
          ...
          >
            ...
            >
              ...
              <span
                ...
                title="AI-generated analysis based on public data."
              >
                ?
              </span>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <div
                    style={{
                      width: `${c.culturalTraits.innovationScore * 10}%`,
                      height: "100%",
                      background: "#f97316",
                    }}
                  ></div>
              ...
              >
                ...
                >
                  <div
                    style={{
                      width: `${c.culturalTraits.speedScore * 10}%`,
                      height: "100%",
                      background: "#f97316",
                    }}
                  ></div>
            ...
            {c.culturalTraits.keywords &&
              c.culturalTraits.keywords.length > 0 && (
                <div
            ...
            <div>
              ...
              <span
                style={{
                  fontWeight: "600",
                  color:
                    c.dart.operatingProfitConsolidated > 0
                      ? "#16a34a"
                      : "#dc2626",
                }}
              >
                ₩
                {(c.dart.operatingProfitConsolidated / 1000000000000).toFixed(
                  1,
                )}
                T
              </span>
